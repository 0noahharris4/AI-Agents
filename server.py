...
# Always show the Analyze button, but disable if missing prerequisites
...
if not uploaded_file:
	...
	analyze_disabled = True
	analyze_help = "OpenAI API key not found. Please set it in Streamlit secrets."

analyze_clicked = st.button("Analyze Log with AI", disabled=analyze_disabled)
if analyze_help:
	st.warning(analyze_help)

# Only run analysis if button clicked and prerequisites are met
if analyze_clicked and uploaded_file and openai_api_key:
